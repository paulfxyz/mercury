...
// ─── Inquiry Wizard — slide-in panel (no Dialog, no overlay) ──
          ...
          <div className="space-y-3">
            ...
            {steps.length < teamSize && (
              <p className="text-xs text-muted-foreground text-center">
                {teamSize - steps.length} more model{teamSize - steps.length !== 1 ? "s" : ""} needed
              </p>
            )}
        ...
        <div className={cn(
          ...
          <div className="flex-1 flex flex-col items-center justify-center p-6 overflow-y-auto">
            <div className={cn(
              ...
              {/* Recent sessions */}
              {!quickMode && !showWizard && recentSessions.length > 0 && (
                <div className="space-y-2">
