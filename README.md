...
[![Version](https://img.shields.io/badge/Version-3.4.0-brightgreen?style=for-the-badge)](CHANGELOG.md)
...
```
  ...
  ║                                                          ║
  ║   v3.4.0  ·  mercury.sh  ·  github.com/paulfxyz          ║
  ╚══════════════════════════════════════════════════════════╝
```
...
Current: **v3.4.0** — debate starter (Quick debate / saved workflow / custom setup), split-panel wizard, model selection fixed, version-stamped releases.
