...
[![Version](https://img.shields.io/badge/Version-3.7.7-brightgreen?style=for-the-badge)](CHANGELOG.md)
...
```
  ...
  ║                                                          ║
  ║   v3.7.7  ·  mercury.sh  ·  github.com/paulfxyz          ║
  ╚══════════════════════════════════════════════════════════╝
```
...
Current: **v3.7.7** — follow-up inquiry, multi-key management, session-only key, mobile layout, debate starter, split-panel wizard, version-stamped releases.
